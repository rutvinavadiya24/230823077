    ...
    <>
        {/* header */}
            ...
            <div className="header">
                ...
                <h1>IshaanAgarwal</h1>
                <p>New Delhi,India110034 + 9122 5555 3345.agarwal@sample.in</p>
            </div>
            <div className='main'>
                <div><hr className='hr'></hr></div><br/>
                <div>
                ...
                <div>
                    ...
                    <p className='p'>Paragraph tags are used to define text t</p>
                ...
                <p className='p'>Paragraph tags are used to define text t</p>
                    ...
                    <ul>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, alias.</li>
                        <li>Lorem ipsum dolor sit amet consectetuParagraph tags are used to define text tr adipisicing elit. In, alias.</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, alias.</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, alias.</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, alias.</li>
                    </ul>
